...
public class BoidsControlPanel extends JPanel {
    ...
    public BoidsControlPanel() {
        ...
        separationRadiusSlider.setMajorTickSpacing(5);
        separationRadiusSlider.setMinorTickSpacing(1);
        ...
        separationWeightSlider.setPaintLabels(true);
        ...
        alignmentWeightSlider.setPaintLabels(true);
        ...
        cohesionWeightSlider.setPaintLabels(true);
